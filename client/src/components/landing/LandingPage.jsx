    ...
    <div className="overflow-hidden bg-bg-primary transition-colors duration-200">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-brand-50 rounded-full blur-3xl opacity-60"></div>
        ...
        <div className="container-custom relative z-10 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              {isAuthenticated ? (
                <>
                  <Link to={`/dashboard/${user?.role}`} className="btn btn-primary btn-large shadow-xl shadow-brand-200 hover:shadow-2xl hover:shadow-brand-300 transform hover:-translate-y-1 transition-all">
                    <span>🎯</span>
                ...
                <>
                  <Link to="/register" className="btn btn-primary btn-large shadow-xl shadow-brand-200 hover:shadow-2xl hover:shadow-brand-300 transform hover:-translate-y-1 transition-all">
                    <span>✨</span>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-16">
              {[
                ...
                <div
                  key={index}
                  className="p-6 rounded-2xl bg-bg-primary border border-border-light shadow-lg shadow-brand-100/20 hover:-translate-y-1 transition-transform duration-300"
                >
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className={`w-14 h-14 mb-6 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-3xl text-white shadow-lg shadow-brand-100`}>
                  {feature.icon}
                </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              <h2 className="text-3xl md:text-5xl font-bold text-text-primary leading-tight">
                Unlock Your Potential with <span className="text-brand-600">Premium Benefits</span>
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg bg-brand-100 flex items-center justify-center text-xl text-brand-600">
                      {benefit.icon}
                    </div>
            ...
            <div className="flex-1 relative">
              <div className="absolute inset-0 bg-brand-50 blur-3xl rounded-full opacity-60"></div>
              <div className="relative bg-bg-primary rounded-3xl p-8 border border-border-light shadow-2xl shadow-brand-100/50 skew-y-3 hover:skew-y-0 transition-transform duration-500">
